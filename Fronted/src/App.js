...
// //     <BrowserRouter>
// //       <Routes>
// //         <Route path="/" element={token?<Todo/>:<Navigate to ="/login" replace/>
// //         }
// //         />
...
//         <Route
//           path="/"
//           element={token ? <Todo /> : <Navigate to="/login" replace />}
//         />
//         <Route path="/login" element={<Login setToken={setToken} />} />
//         <Route path="/register" element={<Register />} />
//       </Routes>
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/login"
          element={<Auth mode="login" setToken={setToken} />}
        />
        <Route
          path="/register"
          element={<Auth mode="register" setToken={setToken} />}
        />
      </Routes>
    </BrowserRouter>
  );
